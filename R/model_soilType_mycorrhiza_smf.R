...
edata <- select(edata, smf, plot, block, replanted, species, brickRatio, soilType, mycorrhiza)
...
plot(smf ~ brickRatio, edata)
plot(smf ~ soilType, edata)
plot(smf ~ mycorrhiza, edata)
par(mfrow = c(2,2))
plot(smf ~ block, edata)
#2way (brickRatio:species):
ggplot(edata, aes(species, smf, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (brickRatio:soilType):
ggplot(edata, aes(soilType, smf, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (brickRatio:mycorrhiza):
ggplot(edata, aes(mycorrhiza, smf, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
...
ggplot(edata, aes(species, smf, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (soilType:mycorrhiza):
ggplot(edata, aes(soilType, smf, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (brickRatio:species:soilType):
ggplot(edata, aes(soilType, smf, color = brickRatio)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (brickRatio:species:mycorrhiza):
ggplot(edata, aes(mycorrhiza, smf, color = brickRatio)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (species:soilType:mycorrhiza):
ggplot(edata, aes(soilType, smf, color = mycorrhiza)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#4way
ggplot(edata,aes(soilType, smf, color = brickRatio, shape = mycorrhiza)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
# interactions with block:
ggplot(edata,aes(brickRatio, smf, color = species)) + geom_boxplot() + facet_wrap(~block) + geom_quasirandom(dodge.width = .7)
ggplot(edata,aes(block, smf, color = species)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(edata,aes(block, smf, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(edata,aes(block, smf, color = soilType)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(edata,aes(block, smf, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
...
dotchart((edata$smf), groups = factor(edata$mycorrhiza), main = "Cleveland dotplot")
dotchart((edata$smf), groups = factor(edata$block), main = "Cleveland dotplot")
par(mfrow=c(1,1));
boxplot(edata$smf, ylim = c(0.1,0.6));#identify(rep(1,length(edata$smf)),edata$smf, labels = c(edata$no))
par(mfrow = c(2,2));
...
#### a models ----------------------------------------------------------------------------------------
#random structure
m1 <- lmer(smf ~ species * brickRatio + (1|block), edata, REML = F)
VarCorr(m1)
#4w-model
