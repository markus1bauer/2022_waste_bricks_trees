...
pdata <- ggemmeans(m4, terms = c("acidbrickRatioTreat", "species"),
                   type = "fe")
pdata <- rename(pdata, smf = predicted, acidbrickRatioTreat = x,
                species = group)
...
### plot ###
(smf <- ggplot(pdata,
               aes(acidbrickRatioTreat, smf, shape = acidbrickRatioTreat,
...
ggsave("figure_A3_G_acid_smf_800dpi_8x7cm.tiff",
