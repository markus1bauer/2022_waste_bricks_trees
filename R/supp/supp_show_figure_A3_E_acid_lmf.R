...
(data <- read_csv2("data_processed_acid.csv",
    ...
    select(lmf, plot, block, species, acidbrickRatioTreat, soilType,
           conf.low, conf.high)
)
...
ggsave("figure_A3_E_acid_lmf_800dpi_8x7cm.tiff",
