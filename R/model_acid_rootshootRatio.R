...
ggplot(edata, aes(soilType, rootshootRatio, color = species)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (species:replanted):
ggplot(edata, aes(replanted, rootshootRatio, color = species)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
...
dotchart((edata$rootshootRatio), groups = factor(edata$acidbrickRatioTreat), main = "Cleveland dotplot")
dotchart((edata$rootshootRatio), groups = factor(edata$block), main = "Cleveland dotplot")
par(mfrow=c(1,1));
boxplot(edata$rootshootRatio);#identify(rep(1,length(edata$rootshootRatio)),edata$rootshootRatio, labels = c(edata$no))
