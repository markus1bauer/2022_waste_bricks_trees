...
data <- select(data, abstransRatio, plot, block, replanted, species, brickRatio, soilType, mycorrhiza)
#Exclude 1 outlier
...
ggplot(data, aes(species, abstransRatio, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (brickRatio:soilType):
ggplot(data, aes(soilType, abstransRatio, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (brickRatio:mycorrhiza):
ggplot(data, aes(mycorrhiza, abstransRatio, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (species:soilType):
ggplot(data, aes(species, abstransRatio, color = soilType)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (species:mycorrhiza):
ggplot(data, aes(species, abstransRatio, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (soilType:mycorrhiza):
ggplot(data, aes(soilType, abstransRatio, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (species:replanted):
ggplot(data, aes(species, abstransRatio, color = replanted)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (brickRatio:species:soilType):
ggplot(data, aes(soilType, abstransRatio, color = brickRatio)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (brickRatio:species:mycorrhiza):
ggplot(data, aes(mycorrhiza, abstransRatio, color = brickRatio)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (species:soilType:mycorrhiza):
ggplot(data, aes(soilType, abstransRatio, color = mycorrhiza)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#4way
ggplot(data,aes(soilType, abstransRatio, color = brickRatio, shape = mycorrhiza)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#interactions with block:
ggplot(data,aes(brickRatio, abstransRatio, color = species)) + geom_boxplot() + facet_wrap(~block) + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, abstransRatio, color = species)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, abstransRatio, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, abstransRatio, color = soilType)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, abstransRatio, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)

##### b Outliers, zero-inflation, transformations? -----------------------------------------------------
par(mfrow = c(2,2))
dotchart((data$abstransRatio), groups = factor(data$species), main = "Cleveland dotplot")
dotchart((data$abstransRatio), groups = factor(data$brickRatio), main = "Cleveland dotplot")
dotchart((data$abstransRatio), groups = factor(data$soilType), main = "Cleveland dotplot")
dotchart((data$abstransRatio), groups = factor(data$mycorrhiza), main = "Cleveland dotplot")
dotchart((data$abstransRatio), groups = factor(data$block), main = "Cleveland dotplot")
par(mfrow=c(1,1));
boxplot(data$abstransRatio)
identify(rep(1, length(data$abstransRatio)), data$abstransRatio, labels = c(data$plot))
plot(table((data$abstransRatio)), type = "h", xlab = "Observed values", ylab = "Frequency")
...
#### a models ----------------------------------------------------------------------------------------
#random structure
m1 <- lmer(abstransRatio ~ species * brickRatio + (1|block), data, REML = F)
VarCorr(m1)
#4w-model
