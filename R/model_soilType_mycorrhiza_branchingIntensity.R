...
data <- select(data, branchingIntensity, plot, block, replanted, species, brickRatio, soilType, mycorrhiza)
...
ggplot(data, aes(species, branchingIntensity, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (brickRatio:soilType):
ggplot(data, aes(soilType, branchingIntensity, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (brickRatio:mycorrhiza):
ggplot(data, aes(mycorrhiza, branchingIntensity, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
...
ggplot(data, aes(species, branchingIntensity, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#2way (soilType:mycorrhiza):
ggplot(data, aes(soilType, branchingIntensity, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
...
ggplot(data, aes(soilType, branchingIntensity, color = brickRatio)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (brickRatio:species:mycorrhiza):
ggplot(data, aes(mycorrhiza, branchingIntensity, color = brickRatio)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#3way (species:soilType:mycorrhiza):
ggplot(data, aes(soilType, branchingIntensity, color = mycorrhiza)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#4way
ggplot(data,aes(soilType, branchingIntensity, color = brickRatio, shape = mycorrhiza)) + facet_grid(~species) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
#interactions with block:
ggplot(data,aes(brickRatio, branchingIntensity, color = species)) + geom_boxplot() + facet_wrap(~block) + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, branchingIntensity, color = species)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, branchingIntensity, color = brickRatio)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, branchingIntensity, color = soilType)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
ggplot(data,aes(block, branchingIntensity, color = mycorrhiza)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
...
dotchart((data$branchingIntensity), groups = factor(data$mycorrhiza), main = "Cleveland dotplot")
dotchart((data$branchingIntensity), groups = factor(data$block), main = "Cleveland dotplot")
par(mfrow=c(1,1));
boxplot(data$branchingIntensity);#identify(rep(1, length(data$branchingIntensity)), data$branchingIntensity, labels = c(data$plot))
...
#### a models ----------------------------------------------------------------------------------------
#random structure
m1 <- lmer(log(branchingIntensity) ~ species * brickRatio + (1|block), data, REML = F)
VarCorr(m1)
#full-model
m2 <- lmer(log(branchingIntensity) ~ species * brickRatio * soilType * mycorrhiza +
             (1|block), data, REML = F)
isSingular(m2)
simulateResiduals(m2, plot = T)
#full 3w-model
m3 <- lmer(log(branchingIntensity) ~ (species + brickRatio + soilType + mycorrhiza)^3 +
             (1|block), data, REML = F)
isSingular(m3)
...
#2w-model full
m5 <- lmer(log(branchingIntensity) ~ (species + brickRatio + soilType + mycorrhiza)^2 +
             (1|block), data, REML = F)
isSingular(m5)
simulateResiduals(m5, plot = T)
#2w-model reduces
m6 <- lmer(log(branchingIntensity) ~ (species + brickRatio + soilType + mycorrhiza) +
             species:brickRatio + species:soilType + species:mycorrhiza +
             (1|block), data, REML = F)
isSingular(m6)
simulateResiduals(m6, plot = T);
#1w-model full
m7 <- lmer(log(branchingIntensity) ~ (species + brickRatio + soilType + mycorrhiza) +
             (1|block), data, REML = F)
isSingular(m7)
...
m4 <- lmer(log(branchingIntensity) ~ (species + brickRatio + soilType + mycorrhiza)^2 +
             species:brickRatio:soilType + species:brickRatio:mycorrhiza +
             (1|block), data, REML = F)
MuMIn::r.squaredGLMM(m4) #R2m = 0.575, R2c = 0.612
VarCorr(m4)
