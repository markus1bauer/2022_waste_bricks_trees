# Show Figure specific root length ~ acid:brickRatio:species ####
...
pd <- position_dodge(.6)
ggplot(pdata, aes(acidbrickRatioTreat, srl, shape = acidbrickRatioTreat, ymin = conf.low, ymax = conf.high))+
  geom_quasirandom(data = edata, aes(acidbrickRatioTreat, srl), 
