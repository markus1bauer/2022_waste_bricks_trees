...
### d Relative growth rates according toKramer-Walter & Laughlin 2017 Plant Soil
  mutate(rgr13 = (log(diameter3 * height3) -
                    log(diameter1 * height1)) / dateDiff13,
         rgr12 = (log(diameter3 * height3) -
                    log(diameter1 * height1)) / dateDiff12,
         rgr23 = (log(diameter3 * height3) -
                    log(diameter1 * height1)) / dateDiff23) %>%
