...
ggplot(edata, aes(soilType, lmf, color = species)) + geom_boxplot() + geom_quasirandom(dodge.width = .7)
...
dotchart((edata$lmf), groups = factor(edata$acidbrickRatioTreat), main = "Cleveland dotplot")
